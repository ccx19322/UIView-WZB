...
- (void)viewDidLoad {
    ...
    [v3 wzb_drawListWithRect:v3.bounds line:3 columns:5 datas:@[@"12月份各地区销售额（万）", @"广东地区", @"4685.36", @"查看详情", @"河南地区", @"6894.09", @"查看详情", @"东北地区", @"10452.78", @"查看详情1", @"上海地区", @"12882.78", @"查看详情2"] lineInfo:@{@"0" : @"1"}];
    // 拿到后边三个label，添加单击手势
